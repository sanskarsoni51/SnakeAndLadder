...
public class SnakeAndLadder {
    ...
    public static void main(String[] args) {
        ...
        // adding player two
        int Pos_Player2 = 0;
        System.out.println("welcome player one. Your starting position will be " + Pos_Player2);
        ...
        while(Pos_Player2 != winning_pos){
            ...
            switch (check) {
                ...
                case Is_Snake:
                    System.out.println("player1 has got snake ");
                    Pos_Player2 = Pos_Player2 - dice;
                    System.out.println("new position of player 1 will be " + Pos_Player2);
                    break;
            
                case Is_Ladder:
                    System.out.println("player one has got ladder");
                    Pos_Player2 = Pos_Player2 + dice;
                    System.out.println("new position of player one will be " + Pos_Player2);
                    break;
            ...
            // telling the position after every dice roll
            System.out.println("player one rolled the dice and got :" + dice + " and moved to position :" + Pos_Player2);
        }
